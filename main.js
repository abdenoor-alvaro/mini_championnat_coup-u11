...
let newsData = {
    news10: {
        img: "news10.png",
        header: "رسميـــــاً | الدور النصف نهائي",
        description: `الفرق الاربعة التي وصلت الي الدور النصف النهائي، مواجهات قوية و متكافئة:
        <br>
        🏆| رائد مستقبل واد تليلات .
        <br>
        🏆| نادي شروق كاسطور .
        <br>
        🏆| نادي شباب كانستال .
        <br>
        🏆| نادي أمل عدل السانيا .`,
        date: "15 Oct 2023",
        lan: "arabic",
        postId: "n10",
        video: "9AqsKS9zNRY?si=RSME1Yw29oEkGM1W"
    },
    news9: {
        img: "news10.jpg",
